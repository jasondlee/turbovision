...
#if defined (Uses_TVConfigFile)
#define INCL_CONFIGFILE_H
#define Uses_stdio
#endif

#if defined (Uses_TVOSClipboard)
...
#if defined (Uses_TCalcDisplay)
#define Uses_TView
#define INCL_CALC_H
#define INCLUDE_STDLIB_H
#endif

#if defined (Uses_TEditorApp)
...
#if defined (Uses_THelpViewer)
 #define Uses_THelpWindow
#endif

#if defined (Uses_THelpWindow)
...
#if defined (Uses_TColorCommands)
...
#if defined (INCLUDE_FONTCOLL_H)
 #include <tv/fontcoll.h>
#endif

// SET: Start of the THelp* classes incorporated in 2.0
#if defined (INCLUDE_HELPBASE_H)
 #include <tv/helpbase.h>
#endif

#if defined (INCLUDE_HELP_H)
 #include <tv/help.h>
#endif
// SET: End of the THelp* classes

// SET: Start of the TEditor classes re-incorporated in 1.0.4
#if defined (INCL_EDITORS_H)
#include <tv/editors.h>
#endif

#if defined (INCL_TVEDIT_H)
#include <tv/tvedit.h>
#endif
// SET: End of the TEditor classes

// SET: Incorporated in 1.0.7
#if defined (INCL_CALC_H)
#include <tv/calc.h>
#endif

#if defined (INCL_OSCLIPBOARD_H)
#include <tv/osclipboard.h>
#endif

#if defined (INCL_CONFIGFILE_H)
